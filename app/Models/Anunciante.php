...
class Anunciante extends Model
{
    ...
    protected $fillable = ['nome_fantasia', 'descricao', 'telefone', 'cidade', 'cep', 'bairro', 'endereco', 'funcionamento', 'cpf_cnpj', 'taxa_de_entrega', 'instagram', 'whatsapp', 'facebook', 'email_anunciante'];
